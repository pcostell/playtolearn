/*
 * File: frontend/interactions/FreeResponseAnswerInteraction.hpp
 */
...
public:
  ...
  FreeResponseAnswerInteraction(Util::UniqueID<Backend::Object> object_id, const std::string& answer);
...
/** FreeResponseAnswerInteraction inlined member functions, public */
